    ...
    def color_calibration(self):
                    ...
                    if not self.colors_calibrated:
                        ...
                        try:
                            ...
                            self.colors_calibrated = True

                        except Exception as e:
                            print("\n[INFO] Color calibration error:", e)

                    if self.colors_calibrated and self.color != "yellow":
                        print("[INFO] Colors calibrated, switching to decoding...")
...
if __name__ == "__main__":
    ...
    video_path = "recordings/sender_v4.mp4"
